...
var _Accuracy = __webpack_require__(27);
...
var _DataPoint = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/DataPoint\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var Accuracy = function (_Component) {
  _inherits(Accuracy, _Component);

  function Accuracy() {
    _classCallCheck(this, Accuracy);

    var _this = _possibleConstructorReturn(this, (Accuracy.__proto__ || Object.getPrototypeOf(Accuracy)).call(this));

    _this.state = {
      list: [{ temp: 27, time: -24 }, { temp: 28, time: -23 }, { temp: 29, time: -22 }, { temp: 30, time: -21 }]
    };
    return _this;
  }
  ...
  _createClass(Accuracy, [{
    key: 'render',
    value: function render() {
      var listItems = this.state.list.map(function (elem, i) {
        return _react2.default.createElement(
          'li',
          null,
          _react2.default.createElement(_DataPoint2.default, null)
        );
      });
      return _react2.default.createElement('div', { 'class': 'graph' });
    }
  }]);
